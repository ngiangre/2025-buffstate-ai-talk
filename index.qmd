...
```{r diagrammr_reporting}

DiagrammeR::mermaid(diagram = '
graph TB
  A("Jira/Excel/Database
     or anything you can easily edit")-->B("API or
                              Persistent Database")
  B-->C("Scheduled Report/Google Docs")
  C-->A
')
...
fold_plot <-
  ...
  geom_text(
    ...
    aes(
      ...
      label = sprintf("FC vs Stage1 = %.2f", fold_change_vs_stage1)
    ),
    nudge_y = 5, size = 3
  ) +
